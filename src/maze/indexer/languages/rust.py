...
class RustIndexer(BaseIndexer):
    ...
    def _extract_struct(self, node: Node, content: str, file_path: str) -> Optional[Symbol]:
    ...
    def _extract_enum(self, node: Node, content: str, file_path: str) -> Optional[Symbol]:
        """Extract enum symbol."""
        name_node = node.child_by_field_name("name")
        if not name_node:
            return None
    ...
    def _extract_trait(self, node: Node, content: str, file_path: str) -> Optional[Symbol]:
    ...
    def _extract_type_alias(self, node: Node, content: str, file_path: str) -> Optional[Symbol]:
        """Extract type alias."""
        name_node = node.child_by_field_name("name")
        if not name_node:
            return None
