#!/usr/bin/env python3
"""
Generate favicon PNGs and og-image for MAZE
...
draw.text((symbol_x, symbol_y), "⊡", fill=ORANGE, font=symbol_font)
...
# Draw subtitle
subtitle = "Adaptive Constrained Code Generation"
...
# Draw tagline
tagline = "Compile constraints before decoding"
